...
if __name__ == "__main__":
    ...
    train_model(train_data_fr, model_path='distilbert-base-multilingual-cased', batch_size=32, epoch=4, learning_rate=3e-5, model_output_base_dir='../../model_output_distilbert', dataset_name='crows_fr_trained', seed=42)
    evaluate_model(test_data_fr, model_output_dir='../../model_output_distilbert/crows_fr_trained', result_output_base_dir='../../result_output_distilbert', dataset_name='crows_fr', seed=42)
