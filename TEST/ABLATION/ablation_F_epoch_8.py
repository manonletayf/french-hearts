...
if __name__ == "__main__":
    ...
    train_model(
        ...
        epoch=8,
        learning_rate=2e-5,
        model_output_base_dir='../../model_output_ablation_epoch8',
        dataset_name='crows_fr_epoch8',
        seed=42,
        max_length=512
    )
    ...
    evaluate_model(
        test_data,
        model_output_dir='../../model_output_ablation_epoch8/crows_fr_epoch8',
        result_output_base_dir='../../result_output_ablation_epoch8',
        dataset_name='crows_fr',
        seed=42,
        max_length=512
    )
