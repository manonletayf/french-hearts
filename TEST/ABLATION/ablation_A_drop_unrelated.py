...
# Removes all 'unrelated' sentences from the dataset
...
if __name__ == "__main__":
    ...
    train_model(
        ...
        epoch=4,
        learning_rate=2e-5,
        model_output_base_dir='../../model_output_ablation_drop_unrelated',
        dataset_name='crows_fr_drop_unrelated',
        seed=42,
        max_length=512
    )
    ...
    evaluate_model(
        test_data,
        model_output_dir='../../model_output_ablation_drop_unrelated/crows_fr_drop_unrelated',
        result_output_base_dir='../../result_output_ablation_drop_unrelated',
        dataset_name='crows_fr',
        seed=42,
        max_length=512
    )
