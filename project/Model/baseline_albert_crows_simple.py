...
# Execute full pipeline for ALBERT-V2 model on CrowS-Pairs French
train_model(
    train_data_crows,
    ...
    epoch=6,
    learning_rate=2e-5,
    model_output_base_dir='model_output_albert_crows_simple',
...
evaluate_model(
    test_data_crows,
    model_output_dir='model_output_albert_crows_simple/crows_fr_trained',
    result_output_base_dir='result_output_albert_crows_simple/crows_fr_trained',
    dataset_name='crows_fr',
    seed=42
)
