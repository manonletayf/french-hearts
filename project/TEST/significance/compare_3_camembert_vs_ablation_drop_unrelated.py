"""
Comparison 3: CamemBERT-FR Final vs Ablation A (without unrelated class)

Objective: Ablation study to evaluate the impact of the "unrelated" class
...
# CamemBERT-FR Final (with unrelated)
PATH_MODEL_A = "../../Model/result_output_camembert_final/crows_fr_final/full_results.csv"
MODEL_A_NAME = "CamemBERT-FR-Final"

# Ablation A: model trained without "unrelated" examples
PATH_MODEL_B = "../../result_output_ablation_drop_unrelated/crows_fr/full_results.csv"
MODEL_B_NAME = "Ablation-A-drop-unrelated"

# Output folder
OUTPUT_DIR = "../../results_significance/camembert_vs_ablation_drop_unrelated"
...
if __name__ == "__main__":
    print("=" * 70)
    print("COMPARISON 3: CamemBERT Final vs Ablation (without unrelated)")
    print("=" * 70)
    print("\nObjective: Impact of 'unrelated' class on performance\n")
    ...
    print("=" * 70)
    print(f"\n{MODEL_A_NAME} (with unrelated):")
    print(f"  F1-macro: {bootstrap_results['f1_model_a']:.4f}")
    print(f"\n{MODEL_B_NAME} (without unrelated):")
