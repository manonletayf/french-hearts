"""
Comparison 8: CamemBERT epochs (hyperparameter)

Objective: Ablation study to evaluate the impact of the number of epochs
on model performance.

CONFIGURATION:
- Model A: CamemBERT Final (epochs par défaut, probablement 6)
- Model B: Ablation epochs=8

NOTE: Si vous avez également des résultats pour epochs=4, créez un script
séparé pour comparer epochs=4 vs epochs=6.
"""
...
# CamemBERT-FR Final (epochs par défaut, probablement 6)
PATH_MODEL_A = "../../result_output_camembert_final/crows_fr_final/full_results.csv"
MODEL_A_NAME = "CamemBERT-epochs-6"

# Ablation epochs=8
PATH_MODEL_B = "../../result_output_ablation_epoch8/crows_fr/full_results.csv"
MODEL_B_NAME = "Ablation-epochs-8"

# Output folder
OUTPUT_DIR = "../../results_significance/camembert_epochs_ablation"
...
if __name__ == "__main__":
    print("=" * 70)
    print("COMPARISON 8: CamemBERT epochs=6 vs epochs=8")
    print("=" * 70)
    print("\nObjective: Impact of number of epochs on performance\n")
