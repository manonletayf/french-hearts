...
# VERSION 2: Modify hyperparameters here to test different configurations
...
# Execute full pipeline for CamemBERT model - VERSION 2
# Change hyperparameters below to test different configurations
train_model(
    train_data_fr,
    model_path='camembert-base',
    batch_size=32,              # Changed from 64 to 32
    epoch=8,                    # Changed from 6 to 8
    learning_rate=3e-5,         # Changed from 2e-5 to 3e-5
    model_output_base_dir='model_output_camembert_v2',    # New directory
    dataset_name='crows_fr_trained_v2',                   # New name
    seed=42
)

evaluate_model(
    test_data_fr,
    model_output_dir='model_output_camembert_v2/crows_fr_trained_v2',
    result_output_base_dir='result_output_camembert_v2/crows_fr_trained_v2',
    dataset_name='crows_fr_v2',
    seed=42
)
