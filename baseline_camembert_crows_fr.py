...
if __name__ == "__main__":
    ...
    # Execute full pipeline for CamemBERT model (French) with categories
    # Execute full pipeline for CamemBERT model
    train_model(train_data_fr, model_path='camembert-base', batch_size=64, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_camembert', dataset_name='crows_fr_trained', seed=42)
    evaluate_model(test_data_fr, model_output_dir='model_output_camembert/crows_fr_trained', result_output_base_dir='result_output_camembert/crows_fr_trained', dataset_name='crows_fr', seed=42)
